# -*- coding: utf-8 -*-
#
# pytest-sqlalchemy documentation build configuration file, created by
...
project = u'pytest-sqlalchemy'
copyright = u'2015, Ben Harling'
author = u'Ben Harling'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-sqlalchemy Documentation',
     [author], 1)
]
